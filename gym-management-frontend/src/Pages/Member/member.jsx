  ...
  const handleSearchData = async () => {
    if (search !== "") {
      ...
      try {
        ...
        toast.error("Error in fetching search data");
        setData([]);
      }
    } else {
      if (isSearchModeOn) {
    ...
    <div className="text-black p-5 w-3/4 h-screen bg-linear-to-r from-[rgb(116,215,220)] to-[rgb(44,110,100)] flex-col ">
      ...
      <div className="mt-3 w-1/2 flex gap-2">
        ...
        <div
          ...
          className="bg-slate-900 p-3 border-2 text-white rounded-2xl cursor-pointer hover:bg-slate-400 "
        >
          <SearchIcon />
        </div>
      </div>
      ...
      <div className="mt-2 text-xl flex text-white  justify-between ">
        ...
        {!isSearchModeOn ? (
          <div className="flex gap-5">
            ...
            <div
              className={`w-8 h-8 cursor-pointer border-2 flex items-center justify-center hover:bg-linear-to-r  from-sky-300  to-fuchsia-300 hover:text-white bg-blue ${currentPage === 1 ? "bg-gray-400 " : "bg-[rgb(62,87,110)]"}`}
              onClick={() => {
                handlePrev();
              }}
            >
            ...
            <div
              className={`w-8 h-8 cursor-pointer border-2 flex items-center justify-center hover:bg-linear-to-r  from-sky-300  to-fuchsia-300 hover:text-white  hover:bg-gray ${currentPage === noOfPage ? "bg-gray-400 " : "bg-[rgb(62,87,110)]"}`}
              onClick={() => {
                handleNext();
              }}
            >
