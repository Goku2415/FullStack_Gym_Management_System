  ...
  return (
    <div className='text-black'>
      <div className='grid gap-5 grid-cols-2 text-lg'>
        ...
        <input  placeholder='Joining Date' type='date' className='border-2 w-[90%] pl-3 pr-3 pt-2 pb-2 border-slate-400 rounded-md h-12' />



        <select  className='border-2 w-[90%] h-12 pt-2 pb-2 border-slate-400 rounded-md placeholder:text-gray'>
        
          <option>1 Months Membership</option>
